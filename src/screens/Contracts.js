...
export default function Contracts(props) {
  ...
  const [contractors, setcontractors] = useState([
    {
      _id: "635a5d6648cda8eca778830b",
      name: "Mith",
      avatar:
        "http://res.cloudinary.com/doxety4ay/image/upload/v1666865110/635a57ae48cda8eca77882c4_profile.jpg",
      email: "testing@mail.com",
      phone: 9873763788,
      company: "Ecorrex",
      availability: "Part time",
      description: "High value assets management ",
      location: "Mombasa ",
      specialization: "Renovation",
      status: "Booked",
      created_date: "2022-10-27T10:28:54.323Z",
      __v: 0,
      clientemail: "andrewfwamba1@gmail.com",
  ...
  const getcontracts = (token) => {
    ...
    axios
      .post("http://192.168.215.143:8000/mycontracts", {
        email: user.email,
        status: "Booked",
      })
